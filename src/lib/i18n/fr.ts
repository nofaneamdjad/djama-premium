...
export const fr: Translations = {
  ...
  home: {
    hero: {
      badge: "Création digitale & accompagnement IA",
      titleLines: ["Votre présence digitale,", "simplifiée."],
      subtitle:
        "Sites web, automatisation, coaching IA et soutien scolaire — des solutions modernes conçues sur mesure pour votre activité.",
  ...
  footer: {
    tagline:
      "Votre partenaire digital — sites web, apps, IA et outils pros pour propulser votre activité.",
    services: {
      title: "Services",
      links: [
