...
export function ColorfulTemplate({ data }: { data: PreviewData }) {
  ...
  return (
    <div style={{ width: "100%", backgroundColor: "#ffffff", fontFamily: "sans-serif", fontSize: 8, lineHeight: 1.35, minHeight: "100%" }}>
      ...
      <div style={{ backgroundColor: C, padding: "16px 20px 14px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
            <div style={{ width: 18, height: 18, borderRadius: 4, backgroundColor: CL, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <div style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: C }} />
            </div>
            <div style={{ color: CT, fontWeight: 900, fontSize: 11, letterSpacing: "-0.3px" }}>{co.name ?? "DJAMA"}</div>
          </div>
      ...
      {/* ── Adresses ── */}
      <div style={{ padding: "10px 20px", display: "flex", gap: 16, borderBottom: `1px solid ${alphaHex(C, 0.2)}` }}>
        <div style={{ flex: 1 }}>
      ...
      <div style={{ padding: "6px 20px" }}>
        <div style={{ backgroundColor: alphaHex(C, 0.06), borderLeft: `3px solid ${CL}`, padding: "4px 8px", borderRadius: "0 4px 4px 0" }}>
      ...
      <div style={{ padding: "4px 20px 0" }}>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            {data.items.map((item, i) => (
              <tr key={i} style={{ backgroundColor: i % 2 === 0 ? "#f0fdf4" : "#ffffff", borderBottom: `1px solid ${alphaHex(C, 0.2)}` }}>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 6 }}>
          <div style={{ width: 140 }}>
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 6, color: MUTED, padding: "2px 0", borderBottom: `1px solid ${alphaHex(C, 0.2)}` }}>
