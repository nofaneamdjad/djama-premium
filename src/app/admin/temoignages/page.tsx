  ...
  return (
    <div className="flex h-full flex-col bg-[#09090b]">
      ...
      <div className="flex flex-1 gap-0 overflow-hidden">
        {/* Liste */}
        <aside className={`flex w-full flex-col border-r border-white/[0.06] sm:w-[300px] sm:flex-none ${mobileView === "editor" ? "hidden sm:flex" : "flex"}`}>
          <div className="border-b border-white/[0.06] p-4">
            <div className="relative">
              <Search size={13} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/25" />
              <input value={query} onChange={e => setQuery(e.target.value)} placeholder="Rechercher…"
                className="w-full rounded-xl border border-white/[0.08] bg-white/[0.04] py-2.5 pl-9 pr-3 text-sm text-white placeholder:text-white/25 outline-none" />
            </div>
          </div>
            ...
            {loadingAll ? (
              ...
              filtered.map(t => (
                <button key={t.id} onClick={() => openItem(t)}
                  className={`w-full border-b border-white/[0.04] px-4 py-3.5 text-left transition hover:bg-white/[0.03] ${selected?.id === t.id ? "bg-white/[0.05]" : ""}`}>
          ...
          {!draft ? (
            ...
            <div className="flex h-full flex-col overflow-hidden">
              ...
              <div className="flex flex-wrap items-center gap-2 border-b border-white/[0.06] px-5 py-3">
                ...
                {dirty && (
                  <span className="hidden items-center gap-1.5 rounded-full border border-[rgba(251,113,133,0.2)] bg-[rgba(251,113,133,0.08)] px-2.5 py-1 text-[0.6rem] font-semibold text-[#fb7185] sm:inline-flex">
                    ...
                    <div className="rounded-[1.25rem] border border-[rgba(251,113,133,0.15)] bg-[rgba(251,113,133,0.04)] p-5">
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        {draft.avatar_url ? (
                          ...
                          <div className="flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-white/[0.08] text-[0.7rem] font-black text-white/50">
