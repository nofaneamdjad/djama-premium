...
export default function DefinirMotDePassePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (sbError) {
      console.error("[DefinirMotDePasse] Erreur :", sbError);
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-[#0f1117]/90 p-8 shadow-[0_32px_80px_rgba(0,0,0,0.6)] backdrop-blur-xl">
          ...
          {done ? (
            ...
            >
              ...
              <h2 className="text-xl font-extrabold text-white">Mot de passe défini !</h2>
              <p className="mt-3 text-sm leading-relaxed text-white/40">
                Votre compte est prêt.
                <br />Ouverture de votre espace…
              </p>
            </motion.div>
            ...
            <>
              <div className="mb-7 text-center">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white/35">
                  Vous êtes connecté avec un code temporaire.
                  <br />Choisissez votre mot de passe définitif.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center gap-2">
                    ...
                    {loading ? "Enregistrement…" : "Confirmer et accéder à l'espace client"}
                  </span>
                </button>
