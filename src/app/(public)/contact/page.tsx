...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // subject n'est pas une colonne Supabase — on le met dans metadata
    ...
    if (error) {
      // Log complet pour diagnostic dans la console du navigateur
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 p-8">
                      ...
                      {sendError && (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          className="flex items-start gap-3 rounded-2xl border border-[rgba(248,113,113,0.25)] bg-[rgba(248,113,113,0.08)] px-4 py-3.5"
                        >
                  ...
                  <div className="mt-6 space-y-2.5">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="truncate text-sm font-semibold text-white/75">{contactEmail}</p>
                      </div>
