        ...
        <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-[#0f1117]/90 p-8 shadow-[0_32px_80px_rgba(0,0,0,0.6)] backdrop-blur-xl">
          ...
          >
            ...
            <div className="text-center">
              <div className="inline-flex items-center gap-1.5 rounded-full border border-[rgba(201,165,90,0.2)] bg-[rgba(201,165,90,0.08)] px-3 py-1 text-[0.65rem] font-bold uppercase tracking-widest"
                style={{ color: GOLD }}>
                Gratuit · Aucune carte requise
              </div>
              <h1 className="mt-3 text-2xl font-extrabold text-white">Créer mon compte</h1>
              <p className="mt-1 text-sm text-white/35">Votre espace client DJAMA en 30 secondes</p>
            </div>
          </motion.div>
          ...
          {/* Note rassurante */}
          <p className="mt-5 text-center text-[0.68rem] text-white/20 leading-relaxed">
            Compte gratuit · Outils Factures, Planning &amp; Bloc-note inclus<br />
            Passez à PRO à tout moment dans votre espace
          </p>
