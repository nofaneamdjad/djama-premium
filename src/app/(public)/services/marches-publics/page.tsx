        ...
        <section className="bg-white py-12 sm:py-24">
          <div className="mx-auto max-w-5xl px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={viewport} variants={staggerContainer} className="mb-12 text-center">
              <motion.span variants={fadeIn} className="badge badge-gold mb-4 inline-flex">
                <Award size={10} /> Avis clients
              </motion.span>
              <h2 className="display-section text-[#09090b]">
                Des dossiers qui{" "}
                <span className="text-[#f9a826]">font la différence</span>
              </h2>
            </motion.div>
            <motion.div initial="hidden" whileInView="visible" viewport={viewport} variants={staggerContainerFast}
              className="grid gap-6 sm:grid-cols-3">
              {[
                { initial: "P", color: "#f9a826", name: "Pierre M.", role: "Gérant d'une entreprise de BTP", stars: 5, text: "Avec l'aide de DJAMA, notre premier dossier de réponse à un AO était irréprochable. Nous avons décroché le marché. L'accompagnement a été décisif." },
                { initial: "N", color: "#60a5fa", name: "Nadia R.", role: "Directrice d'une société de services", stars: 5, text: "DJAMA nous a structuré notre réponse technique en 5 jours. Très bon niveau de rigueur sur les pièces administratives. On recommande." },
                { initial: "B", color: "#4ade80", name: "Bertrand K.", role: "Chef d'entreprise PME industrielle", stars: 5, text: "Notre premier AO était une étape redoutée. DJAMA a simplifié le processus et nous a aidés à remettre un dossier conforme. Résultat positif." },
