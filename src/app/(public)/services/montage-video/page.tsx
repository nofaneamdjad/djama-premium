        ...
        <section className="relative overflow-hidden bg-[#09090b] pb-14 pt-24 sm:pb-24 sm:pt-32">
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center">
            ...
            <motion.div {...fadeIn} transition={{ delay: 0.35 }}>
              <Link href="/contact?besoin=Montage+vidéo" className="btn-primary px-8 py-4 text-base">Demander un devis <ArrowRight size={16} /></Link>
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-[#0e0b18] py-14 sm:py-24">
          <div className="mx-auto max-w-2xl px-6 text-center">
            <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={viewport}>
              ...
              <motion.h2 variants={fadeIn} className="mb-4 text-3xl font-extrabold text-white sm:text-4xl">Prêt à lancer votre projet ?</motion.h2>
              <motion.p variants={fadeIn} className="mx-auto mb-8 max-w-md text-sm text-white/60">
                Décrivez-nous votre besoin vidéo en quelques mots — on vous répond sous 24h avec une estimation personnalisée.
              </motion.p>
