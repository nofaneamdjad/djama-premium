...
const FAQ_ITEMS = [
  ...
  { q: "Puis-je gérer ma boutique moi-même ?", a: "Oui. Vous bénéficiez d'une interface d'administration pour gérer vos produits, commandes, stocks et promotions sans compétence technique." },
  { q: "Peut-on intégrer ma boutique à mon stock physique ?", a: "Oui. Nous pouvons synchroniser votre boutique en ligne avec votre gestion de stock physique (ERP, logiciel de caisse) selon votre configuration." },
  { q: "Quel est le budget pour un site e-commerce ?", a: "Cela dépend du nombre de produits, des fonctionnalités et du niveau de personnalisation. Contactez-nous pour un devis transparent et adapté à votre projet." },
];
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center">
            ...
            <FadeReveal delay={0.2}>
              <p className="mx-auto mb-10 max-w-2xl text-base leading-relaxed text-white/55 sm:text-lg">
                Nous créons votre boutique en ligne avec un parcours simple, un design professionnel et des paiements intégrés.
              </p>
            </FadeReveal>
            <motion.div variants={staggerContainerFast} initial="hidden" animate="show" className="mb-10 flex flex-wrap justify-center gap-4">
              {[{ label: "Paiements intégrés", sub: "Stripe & PayPal" }, { label: "Mobile first", sub: "optimisé smartphone" }, { label: "Prêt à vendre", sub: "dès le lancement" }].map(({ label, sub }) => (
            ...
            <motion.div {...fadeIn} transition={{ delay: 0.35 }}>
              <Link href="#devis" className="btn-primary px-8 py-4 text-base">Lancer ma boutique <ArrowRight size={16} /></Link>
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-[#09090b] py-14 sm:py-24">
          <div className="mx-auto max-w-5xl px-6">
            <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={viewport} className="mb-14 text-center">
              ...
              <motion.h2 variants={fadeIn} className="text-3xl font-extrabold text-white sm:text-4xl">4 étapes pour lancer votre boutique</motion.h2>
            </motion.div>
        ...
        <section className="relative overflow-hidden bg-[#150900] pb-14 pt-14 sm:pb-24 sm:pt-20">
          ...
          <div className="relative mx-auto max-w-2xl px-6 text-center">
            <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={viewport} transition={{ duration: 0.6, ease }}>
              ...
              <h2 className="mb-4 text-3xl font-extrabold text-white sm:text-4xl">Prêt à vendre en ligne ?</h2>
              <p className="mb-8 text-sm leading-relaxed text-white/50 max-w-md mx-auto">Votre boutique clé en main, optimisée pour convertir, prête à accueillir vos premiers clients dès le lancement.</p>
