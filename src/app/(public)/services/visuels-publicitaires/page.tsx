...
function FaqItem({ q, a, open, onToggle }: { q: string; a: string; open: boolean; onToggle: () => void }) {
  return (
    <div className="cursor-pointer rounded-2xl border border-white/[0.07] bg-white transition-all duration-200 hover:border-[rgba(249,168,38,0.25)] hover:shadow-sm" onClick={onToggle}>
        ...
        <section className="bg-[#0c0c0e] py-24">
          <div className="mx-auto max-w-6xl px-6">
            <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={viewport} className="mb-14 text-center">
              ...
              <motion.p variants={fadeIn} className="mt-4 text-sm text-white/45 max-w-xl mx-auto">Posts, stories, bannières, flyers — on couvre tous les formats de vos campagnes.</motion.p>
            </motion.div>
        ...
        <section id="devis" className="bg-[#09090b] py-24">
          <div className="mx-auto max-w-2xl px-6">
            <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={viewport} className="mb-10 text-center">
              ...
              <motion.p variants={fadeIn} className="mt-4 text-sm text-white/45">Partagez votre objectif publicitaire — on crée les visuels qui font la différence.</motion.p>
            </motion.div>
            <DevisForm />
          </div>
        </section>
